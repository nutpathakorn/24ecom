        ...
        <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="check-box-inner pt-0">
                                                ...
                                                <div class="filter-check-box">
                                                    ...
                                                    <p class="ps-25">Be the First to Know. Sign up for
                                                        newsletter
                                                        today !</p>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="checkout-inner border-0">
                                    ...
                                    <div class="check-out-content">
                                        <form id="contact-form" class="p-0" action="{{URL::asset('resources/assets/php/mail.php')}}" method="post">
                                            <div class="form-group row">
                                ...
                                <div class="delivery-options-list">
                                    <form>
                                                        ...
                                                        <div class="col-sm-11 delivery-option-2">
                                                            <div class="row align-items-center">
                                                                <div class="col-sm-5 col-12">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-3">
                                                                            <img src="{{URL::asset('resources/assets/img/icon/10.jpg')}}"
                                                                                alt="My carrier">
                                                                        </div>
                                                                        <div class="col-9">
                                        ...
                                        <div class="order-options">
                                            <div id="delivery" class="text-end">
                                                <label class="text-start d-block">If you would like to add a comment
            ...
            <div class="col-lg-4 mb-30">
                ...
                <div class="delivery-info mt-20">
                    <ul>
                        <li>
                            <img src="{{URL::asset('resources/assets/img/icon/10.png')}}" alt="icon"> Security policy (edit with Customer
                            reassurance module)
                        </li>
                        <li>
                            <img src="{{URL::asset('resources/assets/img/icon/11.png')}}" alt="icon"> Delivery policy (edit with Customer
                            reassurance module)
                        </li>
                        <li class="mb-0">
                            <img src="{{URL::asset('resources/assets/img/icon/12.png')}}" alt="icon"> Return policy (edit with Customer
                            reassurance module)
                        </li>
                    </ul>
                </div>
