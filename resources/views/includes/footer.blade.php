...
<!-- footer end -->
<script src="{{URL::asset('resources/assets/js/vendor/jquery-3.6.0.min.js')}}"></script>
<script src="{{URL::asset('resources/assets/js/vendor/jquery-migrate-3.3.2.min.js')}}"></script>
<script src="{{URL::asset('resources/assets/js/vendor/modernizr-3.7.1.min.js')}}"></script>
<script src="{{URL::asset('resources/assets/js/plugins/jquery-ui.min.js')}}"></script>
<script src="{{URL::asset('resources/assets/js/bootstrap.bundle.min.js')}}"></script>
<script src="{{URL::asset('resources/assets/js/plugins/plugins.js')}}"></script>
